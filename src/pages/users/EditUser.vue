        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="openConfirmation = true">
            ...
            <div class="modal-footer">
              ...
              <button v-if="!openConfirmation" class="btn btn-primary" :disabled="loading" style="background-color: #2FB490 !important; border-radius: 9px !important;">
              ...
              <EditConfirmation v-else :user="user" @update="handleUpdateUser" @cancel="cancelConfirmation" />
            </div>
          </form>
        </div>
      </div>
