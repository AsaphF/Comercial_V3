        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="createUser()">
            ...
            <div class="modal-footer">
              <button class="btn btn-primary" :disabled="loading" style="background-color: #2FB490 !important; border-radius: 9px !important;">
  ...
  methods: {
    ...
    async createUser () {
      ...
      try {
        ...
        this.$toast("Cliente Criado com sucesso!", {
          timeout: 2000
        })
      } catch (err) {
        console.log(err)
