        ...
        <div class="modal-content">
          <div class="modal-header">
            <div class="header-inner">
              ...
              <h6><strong>Quantidade:</strong> {{ users.length }} usuário(s)</h6>
              <div class="tip-container">
                <span><strong>Selecione</strong> o modelo de email que deseja enviar para o seus clientes</span>
          ...
          <div class="modal-footer">
            <div class="buttons-container">
              ...
              <button v-else-if="process === 'loading'" class="btn btn-sm btn-send-mail">
                Carregando
                <svg class="loading-clock" version="1.1" id="L2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
              ...
              <button v-else class="btn btn-sm btn-send-mail" @click.left="sendEmail(this.user)" disabled>
                Concluído <i style="margin-left: 5px !important;" class="fas fa-check"></i>
              </button>
            </div>
          </div>
        </div>
...
export default {
  props: ['affiliate', 'users', 'modelsLists'],
  data: () => ({
    errorOff: true,
    user: {},
    favoritesList: [],
  ...
  async mounted () {
    this.$root.$on('ShippingClients::show', () => this.openModal())
  },
  methods: {
    async openModal () {
      this.showModal = true
        ...
        for (let index = 0; index < this.users.length; index++) {
          ...
          if (this.model.type === 'Apresentação') {
            ...
            if (result === 200) {
              ...
              this.users[index].sended = result
              this.process = 'error'
            ...
            if (result === 200) {
              ...
              this.users[index].sended = false
              console.log('Essa lead não deu certo:' + this.user)
            }
          }
        }
        this.process = this.process === 'error' ? 'error' : 'concluded'
        this.$toast("Envio efetuado com sucesso!", {
          timeout: 2000
        })
        setTimeout(() => {
