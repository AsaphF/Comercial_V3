                ...
                <div v-else class="creation-container">
                  <div v-if="!templateList" class="container-template">
                    ...
                    <div class="container-template-footer">
                      <button v-if="localList.length > 0" class="btn-undo" @click="getBack()">
                          ...
                          <div class="inner-form-container">
                            <div class="help-container">
                              <div class="container-title">
                                ...
                                <input v-model="firstTemplate.templateTitle" class="input-title" type="text" name="" id="" placeholder="Título do modelo do texto para Email" maxlength="130" required>
                              </div>
                              <div class="buttons-container">
...
export default {
  ...
  methods: {
    ...
    handleExclusion (model) {
      ...
      this.$toast("Modelo de texto excluído com sucesso!", {
          timeout: 2000
      });
    },
    getBack () {
