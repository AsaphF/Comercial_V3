          ...
          <div class="modal-content">
            <div class="modal-header">
              <div class="upward-header">
                <h4>Configuração do WhatsApp/BotConversa</h4>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="report-container">
                                      <div class="inner-container-report">
                                        <textarea v-if="showAndHide" v-model="textAreaWhats" style="font-size: 14px;;"  placeholder="Digite sua mensagem modelo. Clique em 'Como usar' para mais informações." required></textarea>
                                        <textarea v-else v-model="textAreaCopy" style="font-size: 14px;"  placeholder="Digite sua mensagem modelo. Clique em 'Como usar' para mais informações." :disabled="!showAndHide" required></textarea>
                                      </div>
                                  </div>
                                </div>
    ...
    .body-content {
      ...
      .container-list {
        ...
        .inner-container {
          ...
          justify-content: space-between;
          margin-bottom: 8px;
          padding: 10px 37px 0px 43px !important;
