<template>
  <div class="container-fluid" v-if="loggedAffiliate.actived">
    <div class="row">
      <layout-navigation/>
      <EmailConfig :affiliate="loggedAffiliate" :modelsLists="modelEmailList"/>
      <WhatsConfig :affiliate="loggedAffiliate" :modelsLists="modelsWhatsList"/>
      <SavingKeyAPI :affiliate="loggedAffiliate"/>
      <Shipping :affiliate="loggedAffiliate" :leads="selectedLeads" :modelsWhatsLists="modelsWhatsList"/>
      <MonitoringAffiliates ref="MonitoringRef" :leads="allLeads"/>
      <MonitorLeads ref="monitorLeadRef" :loggedAffiliate="loggedAffiliate"/>
      <ModelsLeads ref="modelsListsRef" :affiliate="this.loggedAffiliate" :lead="lead" :emailList="modelEmailList" :whatsList="modelsWhatsList" :id="type"/>
      <NewAffiliate :affiliate="loggedAffiliate" />
            ...
            <div class="row info-container header-page-container" style="border-radius: 9px !important;">
              <div class="left-container">
                <div class="first-inner-container">
                  <h4 class="title">Hot Leads</h4>
                </div>
                <p class="subtitle mt-2">
                  Boas vendas! Seus resultados na conversão de leads refletem seu trabalho árduo e determinação.
                </p>
              </div>
                  ...
                  <div class="dropdown-menu">
                    <button type="button" class="btn btn-sm btn-config-whats" @click="openWhatsConfig()">
                      <svg width="21" height="21" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M2.15544 10.4119C2.15544 7.415 4.5849 4.98553 7.58181 4.98553H12.0734C15.0703 4.98553 17.4998 7.415 17.4998 10.4119C17.4998 13.4088 15.0703 15.8382 12.0734 15.8382H7.58181C4.5849 15.8382 2.15544 13.4088 2.15544 10.4119Z" fill="#13cf9a" stroke="#068373"/>
                        <path d="M1.66159 0.499512C2.30312 0.499512 2.82319 1.01958 2.82319 1.66111V9.91218H1.66159H0.5L0.5 1.66111C0.5 1.01958 1.02006 0.499512 1.66159 0.499512Z" fill="#13cf9a" stroke="#068373"/>
                        <path d="M8.91913 10.4114C8.91913 11.058 8.40198 11.573 7.77536 11.573C7.14881 11.573 6.63165 11.058 6.63165 10.4114C6.63165 9.76471 7.14881 9.24976 7.77536 9.24976C8.40198 9.24976 8.91913 9.76472 8.91913 10.4114Z" fill="#13cf9a" stroke="#068373"/>
                        <path d="M14.1232 10.4114C14.1232 11.058 13.606 11.573 12.9794 11.573C12.3528 11.573 11.8357 11.058 11.8357 10.4114C11.8357 9.76472 12.3528 9.24976 12.9794 9.24976C13.606 9.24976 14.1232 9.76471 14.1232 10.4114Z" fill="#13cf9a" stroke="#068373"/>
                        <path d="M0.5 10.4123C0.5 6.49859 3.6706 3.3244 7.58351 3.3244H8.47414C9.11566 3.3244 9.6357 3.84445 9.6357 4.48599C9.6357 5.12754 9.11566 5.64759 8.47414 5.64759H7.58351C4.95532 5.64759 2.82319 7.77997 2.82319 10.4123C2.82319 13.0447 4.95531 15.1771 7.58351 15.1771H11.8896C12.5311 15.1771 13.0512 15.6972 13.0512 16.3387C13.0512 16.9802 12.5311 17.5003 11.8896 17.5003H7.58351C3.6706 17.5003 0.5 14.3261 0.5 10.4123Z" fill="#13cf9a" stroke="#068373"/>
                        </g>
                        <defs>
                    ...
                    <button type="button" class="btn btn-sm btn-bunch" @click="saveBotconversaAPI()">
                    ...
                    <button v-if="loggedAffiliate.adm" class="monitoring" @click="openMonitoring()">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.1917 12C18.5068 12 20.3835 13.8767 20.3835 16.1917C20.3491 18.4924 18.4924 20.3491 16.1917 20.3835C13.8767 20.3835 12 18.5068 12 16.1917C12 13.8767 13.8767 12 16.1917 12" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M2.99625 16.0017V18.0025C2.99625 19.1075 3.89205 20.0033 4.99708 20.0033H8.99875" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M21.0038 9.99916V4.99708C21.0038 3.89205 20.108 2.99625 19.0029 2.99625H13.0004" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M17.6173 15.4584L15.8356 17.2392L14.7651 16.1717" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M9.99916 11.4998H3.49645C3.2202 11.4998 2.99625 11.2758 2.99625 10.9996V10.5934C2.99954 9.43781 3.93552 8.50183 5.09112 8.49854H8.4045C9.5601 8.50183 10.4961 9.43781 10.4994 10.5934V10.9996C10.4994 11.2758 10.2754 11.4998 9.99916 11.4998Z" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.7478 5.99749C5.64381 5.99749 4.74845 5.1033 4.74698 3.99932C4.74552 2.89533 5.6385 1.99877 6.74248 1.99583C7.84647 1.99289 8.74422 2.88468 8.74865 3.98866C8.75076 4.5207 8.5409 5.03167 8.16544 5.40864C7.78998 5.7856 7.27984 5.99749 6.7478 5.99749Z" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                      <span>Atribuir Leads</span>
                    </button>
                    <button v-if="loggedAffiliate.adm"  class="btn btn-sm btn-register" @click="openNewAffiliate()">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.0033 15.1286V6.99825C20.0033 4.78833 18.2116 2.99658 16.0017 2.99658H6.99791C4.78799 2.99658 2.99625 4.78833 2.99625 6.99825V16.002C2.99625 18.2119 4.78799 20.0037 6.99791 20.0037H15.1283" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12.7573 7.68247C13.6367 8.56184 13.6367 9.98643 12.7573 10.8658C11.8779 11.7452 10.4534 11.7452 9.57398 10.8658C8.69462 9.98643 8.69462 8.56184 9.57398 7.68247C10.4534 6.80311 11.8779 6.80311 12.7573 7.68247" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M14.0008 14.4714C13.5907 14.2473 13.1235 14.1143 12.6223 14.1143H9.70905C8.46354 14.1143 7.4121 14.9016 6.99792 16.002" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M20.2534 19.0671H17.7524" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M19.0029 17.8169V20.3179" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M19.0029 15.0015C21.2128 15.0015 23.0046 16.7932 23.0046 19.0031C23.0046 21.2131 21.2128 23.0048 19.0029 23.0048C16.793 23.0048 15.0013 21.2131 15.0013 19.0031C15.0013 16.7932 16.793 15.0015 19.0029 15.0015" stroke="#068373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                      <span>Cadastrar</span>
                    </button>
                  </div>
            ...
            <div class="row search-container">
              <div class="col-12 search-wrapper">
                ...
                <input
                  ...
                  placeholder="Digite a lead deseja buscar..."
                  required
                >
              </div>
            </div>
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th scope="col" style="width: 160px; padding-left: 15px !important">
                  <span style="margin-right: 5px;" @click="sortForStatus">Situação</span>
                </th>
                <th scope="col" style="width: 320px;">
                  <span style="margin-right: 10px;">Nome</span>
                </th>
                <th scope="col" style="width: 200px; padding-left: 2px !important">
                  <span style="margin-right: 5px;">Telefone</span>
                </th>
                <th scope="col" style="width: 350px; padding-left: 1px !important">
                  <span style="margin-right: 5px;">E-mail</span>
                </th>
                <th scope="col" style="width: 150px; padding-left: 10px !important">
                  <span style="margin-right: 5px;">Clientes</span>
                </th>
                <th scope="col" style="width: 160px;">
                  <span style="margin-left: 5px;" @click="sortForDate">Incrição</span>
                </th>
                <th scope="col" style="width: 160px;">
            ...
            <tbody v-if="!loading">
              <tr :key="i" v-for="(lead, i) in filteredLeads">
                <!-- (scrollPosition + 40*60)+150 > i*56 && (scrollPosition - 40*60)-16*60 < i*56 -->
                <template v-if="scrollPosition + 40*80 > i*59 && scrollPosition - 40*80 < i*59">
                  ...
                  <td v-if="lead && lead.name.length > 20" :class="{unfocus: lead.checked}" @click="searchValue = lead.name" style="padding-right: 0px !important; padding-left: 0px !important;">{{ lead.name.toUpperCase().slice(0, 30) }}...</td>
                  ...
                  <td :class="{unfocus: lead.checked}" style="padding-left: 20px !important;">
                    <button class="btn  btn-sm btn-primary-border" @click="openMonitorLead(lead)" style="margin-right: -15px !important;">
                ...
                <template v-else>
                  <td style="width: 158.91px !important;"><div class="loading-md"></div></td>
                  <td style="width: 273.16px !important;"><div class="loading-md"></div></td>
                  <td style="width: 175.16px !important;"><div class="loading-md"></div></td>
                  <td style="width: 338.78px !important;"><div class="loading-md"></div></td>
                  <td style="width: 136.78px !important;"><div class="loading-md"></div></td>
                  <td style="width: 152.56px !important;"><div class="loading-md"></div></td>
                  <td style="width: 152.56px !important;"><div class="loading-md"></div></td>
                  <td style="width: 85.84px !important;"><div class="loading-dropdown"></div></td>
                  <td style="width: 173.25px !important;"><div class="loading-btn"></div></td>
                </template>
              </tr>
            </tbody>
            <tbody v-else>
...
import ModelsLeads from './ModelsLeads.vue'
import MonitoringAffiliates from './MonitoringAffiliates'
import SavingKeyAPI from '../../components/global/SavingKeyAPI.vue'
import EmailConfig from './EmailConfig.vue'
import moment from 'moment'
import WhatsConfig from './WhatsConfig.vue'
import NewAffiliate from './NewAffiliate.vue'
import MonitorLeads from './MonitorLeads.vue'
...
export default {
  ...
  beforeDestroy () {
    ...
    this.$firebase.database().ref(`hotLeads/${window.uid}`).off()
  },
  computed: {
    filteredLeads () {
      let tempUsers = []
          ...
          if (this.searchValue.toLowerCase() === 'ligar') {
            ...
            switch (true) {
              ...
              case lead.originData && lead.originData.origin && lead.originData.origin.toUpperCase().includes(this.searchValue.toUpperCase()):
                ...
                break
              case lead.date && moment(lead.date).format('DD/MM/YYYY')=== (this.searchValue.toUpperCase()):
                result = lead.date
                break
            }
            return result
    ...
    checkedDate () {
      const lastSendDate = new Date(this.lead.lastSendDate.date)
      const currentDate = new Date()

      const isSameDay = (
        lastSendDate.getFullYear() === currentDate.getFullYear() &&
        lastSendDate.getMonth() === currentDate.getMonth() &&
        lastSendDate.getDate() === currentDate.getDate()
      )
  ...
  methods: {
    // Inicialização, requisição do BD
    async getInfo () {
      ...
      await this.$firebase.database().ref('hotLeads').on('value', snapshot => {
        ...
        if (values) {
          ...
          let thirds = []
          let onAndOn = []
          this.leads = this.allLeads.filter(lead => lead.affiliateId && lead.affiliateId === this.loggedAffiliate.affiliateId)
          firsts = this.leads.filter(lead => lead.status && lead.status.info === 'Ligar')
          seconds = this.leads.filter(lead => lead.status && lead.dtReturn && lead.status.info !== 'Ligar')
          seconds.sort(function (a, b) { new Date(a.dtReturn) - new Date(b.dtReturn) })
          secondsAndHalf = this.leads.filter(lead => lead.status && (!lead.dtReturn && lead.status.info === 'Retornar'))
          thirds = this.leads.filter(lead => lead.status && lead.status.info === 'Cadastrado')
          onAndOn = this.leads.filter(lead => lead.status.info !== 'Retornar' && lead.status.info !== 'Ligar' && lead.status.info !== 'Cadastrado')
          this.leads = [...firsts, ...seconds, ...secondsAndHalf, ...thirds, ...onAndOn]
    ...
    checkMessage (lead) {
      ...
      const regex = /\[([^\]]+)\]/g
      const matchesTitle = [...this.loggedAffiliate.mailTitle.matchAll(regex)]
      ...
      for (const word of wordsInTitle) {
        if (word.toLowerCase() === 'nome') {
          ...
          this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace(regexName, firstName)
        }
        if (word.toLowerCase() === 'telefone') {
          const regexPhone = /\[([^\]]*telefone[^\]]*)\]/g
          this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace(regexPhone, lead.phone)
        }
        if (word.toLowerCase() === 'email' || word.toLowerCase() === 'e-mail') {
          const regexmail1 = /\[([^\]]*email[^\]]*)\]/g
          const regexmail2 = /\[([^\]]*e-mail[^\]]*)\]/g
          this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace(regexmail1, lead.email)
          this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace(regexmail2, lead.email)
        }
        if (word.toLowerCase() === 'origem' && lead.originData && lead.originData.origin) {
          const regexOrigin = /\[([^\]]*origem[^\]]*)\]/g
          this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace(regexOrigin, lead.originData.origin)
        }
      }
      this.loggedAffiliate.mailTitle = this.loggedAffiliate.mailTitle.replace('\n', '<br>')
      // Formatar Corpo do email
      const matches = [...this.loggedAffiliate.mailBody.matchAll(regex)]
      ...
      for (const word of wordsInBody) {
        if (word.toLowerCase() === 'nome') {
          ...
          const sum = letter + name
          const firstName = sum.split(' ')[0]
          this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace(regexName, firstName)
        }
        if (word.toLowerCase() === 'telefone') {
          const regexPhone = /\[([^\]]*telefone[^\]]*)\]/g
          this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace(regexPhone, lead.phone)
        }
        if (word.toLowerCase() === 'email' || word.toLowerCase() === 'e-mail') {
          const regexmail1 = /\[([^\]]*email[^\]]*)\]/g
          const regexmail2 = /\[([^\]]*e-mail[^\]]*)\]/g
          this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace(regexmail1, lead.email)
          this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace(regexmail2, lead.email)
        }
        if (word.toLowerCase() === 'origem' && lead.originData && lead.originData.origin) {
          const regexOrigin = /\[([^\]]*origem[^\]]*)\]/g
          this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace(regexOrigin, lead.originData.origin)
        }
      }
      this.loggedAffiliate.mailBody = this.loggedAffiliate.mailBody.replace('\n', '<br>')
    },
    changeTable () {
      if (this.checkTable) {
        for (let index = 0; index < this.leads.length; index++) {
    ...
    selectAll () {
      if (this.selectedAll) {
        ...
        for (let index = 0; index < this.leads.length; index++) {
          this.leads[index].selected = true
          this.leads[index].checked = false
        }
    ...
    sendSelected () {
      const selected = this.leads.filter(lead => lead.selected === true)
      if (selected.length > 0) {
        this.selectedLeads = selected
        this.$root.$emit('Shipping::show')
      }
    },
    openModalModels (lead, type) {
      this.lead = {}
      this.type = ''
      this.lead = lead
      this.type = type
    ...
    openWhatsConfig () {
      this.$root.$emit('WhatsConfig::show')
    },
    openEmailConfig () {
      this.$root.$emit('EmailConfig::show')
    },
    saveBotconversaAPI () {
      this.$root.$emit('SavingKeyAPI::show')
    },
    openMonitoring () {
      this.$refs.MonitoringRef.openModal()
    },
    openMonitorLead (lead) {
      this.lead = lead
      this.$refs.monitorLeadRef.initialChanges(this.lead)
    },
    openNewAffiliate () {
      this.$root.$emit('NewAffiliate::show')
    },
    async accessAccount (email, password) {
      await this.$root.$emit('verifyActived')
      const actived = await this.$firebase.database().ref(`affiliates/${window.uid}/actived`).once('value').then(snapshot => snapshot.val())
      const name = await this.$firebase.database().ref(`affiliates/${window.uid}/name`).once('value').then(snapshot => snapshot.val())
      if (actived) {
    ...
    sortForStatus () {
      ...
      if (this.sortedByStatus) {
        tempUsers.sort((a, b) => {
          const fa = a.status.info.toLowerCase()
          const fb = b.status.info.toLowerCase()
          if (fa < fb) {
            return -1
          }
          if (fa > fb) {
