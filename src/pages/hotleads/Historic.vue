        ...
        <div class="box">
          <div class="container">
            <template v-if="origin === 'whats'">
              ...
              <div class="cards">
                <div v-for="(saved, index) in historic" :key="index" class="card">
                  <h4>
                  ...
                  <span>{{ saved.leadName}}</span></h4>
                  <p><strong>Enviado para:</strong> {{ saved.leadPhone }}</p>
                  <p><strong>Título do modelo enviado:</strong> {{ saved.modelTitle.slice(0, 81) }}...</p>
