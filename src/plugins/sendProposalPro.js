...
const sendProposalPro = async (affiliate, planClients, planPricePerClient, planMonthlyPrice, planSavedHours, email) => {
                    ...
                    <table class="sm-w-full" style="width: 75%" cellpadding="0" cellspacing="0" role="none">
                      <tr>
                        <td class="sm-px-6" style="font-family: 'Poppins', Arial, sans-serif; border-radius: 16px; background-color: #fff; padding: 48px; text-align: left; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)">
                          ...
                          <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 4px; font-size: 16px; color: #334155"><span style="font-weight: 600;">SimplesHub Pro</span> - até ${planClients} clientes</p>
                          <p style="font-family: 'Poppins', Arial, sans-serif; margin-top: 0; font-size: 20px; font-weight: 600; color: #2FB490">R$ ${planPricePerClient} por cliente</p>
                          ...
                          <table style="margin-top: 8px; border: 0px solid rgb(16 185 129 / 0.25); border-left-width: 4px; padding-left: 8px; border-spacing: 0 4px" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle">Emissão automática de guias fiscais</td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif; vertical-align: middle;"><img src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FSistema-Comercial%2FEmail-Proposta%2Fsend.png?alt=media&token=1d2d6672-accd-4fb1-bfeb-ae368acf75f2" alt="Envio" style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0;"></td>
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Envio automático (E-mail e WhatsApp)</td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif; vertical-align: middle;"><img src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FSistema-Comercial%2FEmail-Proposta%2Fstrategy.png?alt=media&token=f1281797-b66e-4624-9a34-a929f095e31f" alt="Estratégia" style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0;"></td>
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Visão estratégica interativa</td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Adicione usuários da sua equipe</td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif; vertical-align: middle;"><img src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FSistema-Comercial%2FEmail-Proposta%2Fsearch.png?alt=media&token=e229f3a3-2ea5-4fe7-9f40-7f0f026bc9e8" alt="Rastreio" style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0;"></td>
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Rastreio de envio e visualização</td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">E-mail de envio personalizado</td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Download de guias em lote</td>
                            </tr>
                          </table>
                          <table style="margin-top: 0; border: 0px solid rgb(16 185 129 / 0.25); border-left-width: 4px; padding-left: 8px; border-spacing: 0 4px;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif;">
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 16px; margin-top: 20px; font-size: 16px; font-weight: 600; color: #374151">Guias compatíveis</p>
                                ...
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 16px; margin-top: 0; font-size: 12px; color: #64748b;">Extratos, recibos, DARFs e MAED</p>
                                ...
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 16px; margin-top: 0; font-size: 12px; color: #64748b;">Simples Nacional, Receita Federal, Especiais e PGFN</p>
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-top: 0; margin-bottom: 0; font-size: 14px; font-weight: 600; color: #64748b;">Certidões e Relatórios</p>
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 0; margin-top: 0; font-size: 12px; color: #64748b;">Relatório de Situação Fiscal Federal</p>
                          ...
                          <table style="margin-top: 8px; border: 0px solid rgb(16 185 129 / 0.25); border-left-width: 4px; padding-left: 8px; border-spacing: 0 4px;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Site fiscal personalizado</td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Importe e envie qualquer PDF</td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif; vertical-align: middle;"><img src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FSistema-Comercial%2FEmail-Proposta%2Fscanner.png?alt=media&token=138accce-931e-4106-8309-c1f96132de16" alt="Estratégia" style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0;"></td>
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Disparo por inteligência artificial</td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Rastreie status de pagamento</td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif; vertical-align: middle;"><img src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FSistema-Comercial%2FEmail-Proposta%2Fchat.png?alt=media&token=5f0ab85f-d76e-4cdf-99f6-c22db20fcc33" alt="Rastreio" style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0;"></td>
                              <td style="font-family: 'Poppins', Arial, sans-serif; padding-left: 8px; padding-top: 4px; font-size: 14px; color: #334155; vertical-align: middle;">Dispare comunicados em massa</td>
                            </tr>
                          </table>
                          <table style="margin-top: 0; border: 0px solid rgb(16 185 129 / 0.25); border-left-width: 4px; padding-left: 8px; border-spacing: 0 4px;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                              <td style="font-family: 'Poppins', Arial, sans-serif;">
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-bottom: 8px; margin-top: 20px; font-size: 16px; font-weight: 600; color: #374151">Guias compatíveis</p>
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-top: 0; margin-bottom: 0; font-size: 14px; font-weight: 500; color: #64748b">Qualquer arquivo .PDF</p>
                                <p style="font-family: 'Poppins', Arial, sans-serif; margin-top: 0; margin-bottom: 0; font-size: 14px; font-weight: 500; color: #64748b;">Todas as guias do Emissão Simples</p>
                              </td>
                            </tr>
                          </table>
                          <hr style="margin-top: 20px; border-width: 2px; border-color: rgb(100 116 139 / 0.1);">
  ...
  const payload = {
    body: htmlContent,
    subject: 'Teste de Envio de Email - Proposta Comercial',
    emailTo: email
  }
...
export default sendProposalPro
