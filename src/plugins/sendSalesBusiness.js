...
const sendSalesBusiness = async (affiliate, clientName, clientEmail, emailTitle, emailText) => {
  ...
  <body class="m-0 p-0 w-fullword-break-break-word -webkit-font-smoothing-antialiased " style="margin: 0; padding: 0; -webkit-font-smoothing: antialiased;">
    <div role="article" aria-roledescription="email" aria-label lang="en">

      <table class="w-full font-sans" style="width: 100%; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif;" cellpadding="0" cellspacing="0" role="none">
        <tr>
          <td align="center" class="bg-slate-100 py-6" style="background-color: #f1f5f9; padding-top: 24px; padding-bottom: 24px;">
            <table class="w-600px sm-w-full" style="width: 600px;" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <div class="w-48 mx-auto mb-4" style="margin-left: auto; margin-right: auto; margin-bottom: 16px; width: 192px;">
                  <img class="w-full" src="https://firebasestorage.googleapis.com/v0/b/emissaosimplesweb.appspot.com/o/images%2FEmail-Marketing%2Fconfirmation%2Flogotype-75px.png?alt=media&token=73fcb281-c123-4738-ae98-b678416b9068" alt style="width: 100%;">
                </div>
              </tr>
              <tr>
                <td align="center" class="sm-px-8">
                  <table class="w-3-4 sm-w-full" style="width: 75%;" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td class="bg-white p-12 sm-px-6 text-left rounded-2xl shadow-lg" style="border-radius: 16px; background-color: #fff; padding: 48px; text-align: left; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1);">
                        <p class="text-lg font-semibold m-0 text-slate-800" style="margin: 0; font-size: 18px; font-weight: 600; color: #1e293b;">
                          ${title}
                        </p>
                        <p class="text-sm font-regular text-slate-700" style="font-size: 14px; color: #334155;">
                          ${text}
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td class="h-8" style="height: 32px;"></td>
                    </tr>

                    <tr>
                      <td class="bg-white px-8 py-6 sm-px-6 text-left rounded-2xl shadow-lg" style="border-radius: 16px; background-color: #fff; padding: 24px 32px; text-align: left; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                      <td class="p-8 text-center text-gray-600 text-xs" style="padding: 32px; text-align: center; font-size: 12px; color: #4b5563;">
  ...
  const payload = {
    body: htmlContent,
    subject: 'Teste de Envio de Email - Modelo Apresentação',
    emailTo: clientEmail
  }
...
export default sendSalesBusiness
